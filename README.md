...
Заповнюється на ЛР1 і оновлюється, якщо щось змінилось. Студент
індивідуального плану заповнює її на себе: у полі команди прізвище, у складі
одна людина.
...
lr04_kanban/             дошка команди: DoW, WIP-ліміти, дати карток для ЛР14
lr05_charter/            статут + stakeholders.csv
lr06_backlog/            backlog.csv
lr07_wbs/                wbs.csv + roadmap.csv
lr08_poker/              votes.csv + estimates.csv, сесію команда проводить сама
lr09_forecast/           velocity.csv + forecast.csv
lr10_demo/               review.md на іншу команду + README.md з реакцією
...
Здається все, порожніх папок у шаблоні немає. Різниця лише в балах: дванадцять
робіт дають по 5 балів за рубрикою, а ЛР3, ЛР4, ЛР8, ЛР10 і ЛР13 балів не дають
і перевіряються тільки на те, що вони є і що ними можна користуватись далі.

Дві роботи здаються по одному файлу на людину, а не на команду: журнал спринта
`lr03_sprint_simulation/sprint_log_<логін>.md` і діалоги
`lr13_roleplay/dialogue_<логін>.md`. Каркас у папці лишається порожнім, ви
копіюєте його під свій логін.

Роботи без балів не безкоштовні: без журналу спринта нема з чим іти в ЛР4, без
дат із дошки нема що аналізувати на ЛР14, без оцінок із покеру нема на чому
будувати прогноз ЛР9. У студента індивідуального плану ці папки теж
заповнюються: туди йдуть модулі M4 і M5.
...
сім днів, 23:59. У студента індивідуального плану цикл той самий, а дедлайни
задані трьома пакетами модулів в умові треку. Дата здачі береться з git, тому
окремо нічого надсилати не треба:
