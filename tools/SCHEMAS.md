...
Згенеровано з `tools/schemas.json`, версія схеми **1.8.0**, оновлено 2026-09-05.
...
| Правило | Рівень | Опис |
| :-: | :-: | --- |
| `X-1` | error | Кожен story_id в estimates.csv, votes.csv, risks.csv і flow.csv існує в backlog.csv |
